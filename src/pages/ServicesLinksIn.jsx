    ...
    <>
            ...
            <div className="slide-content-m min10 info">
              <div className="texts">
                ...
                <p>
                  ...
                  alabilirler. Danışmanlar, öğrencilerin akademik geçmişlerine
                  ve hedeflerine uygun eğitim programlarını belirlemelerine
                  yardımcı olur.
                </p>
                <div className="myBtn">
                  <button>
      ...
      <div className="about-page">
        <div className="container">
          ...
          <div className="servicesLink_blog">
            {servicesLinks.map((item) => (
              <div className="servicesLink_texts">
                <h2>{item.title}</h2>
                <p>{item.desc}</p>
              </div>
            ))}
      ...
      <MobileServicesLinksIn />
    </>
  );
}

export default ServicesLinksIn;
